                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                ?>
                                <a class="dropdown-item" href="../views/configuracion_perfil.php">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Perfile
                                </a>
                                <a class="dropdown-item" href="../views/configuracion.php">
                                    <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Configuraciones
                                </a>
                                <a class="dropdown-item" href="../views/configuracion_historial_entrada.php">
                                    <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Actividades
                                </a>
                                <a class="dropdown-item" href="../views/configuracion_historial_actividades.php">
                                    <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
